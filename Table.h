...
// add private data and methods here
    ...
    unsigned int entryNum; //total number of elements in the hash table
    unsigned int nonemptyBucket; //the number of non-empty bucket in the hash table
    unsigned int longestChain; //the length of the longest chain in the hash table
  
    ListType * data; //pointer to store all chains in the hash table
    int * chainLen; //pointer to store the length of all chains in the hash table

    void calcLongestChain(); //calculate the longest chain in the hash table
